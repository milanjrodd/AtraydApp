...
export const Github: React.FC<ISvgProps> = (props) => {
  return (
    <svg
      aria-hidden="true"
      data-prefix="fab"
...
export const Twitter: React.FC<ISvgProps> = (props) => {
  return (
    <svg
      aria-hidden="true"
      data-prefix="fab"
...
export const Facebook: React.FC<ISvgProps> = (props) => {
  return (
    <svg
      aria-hidden="true"
      data-prefix="fab"
...
export const YouTube: React.FC<ISvgProps> = (props) => {
  return (
    <svg
      aria-hidden="true"
      data-prefix="fab"
...
export const YinYang: React.FC<ISvgProps> = (props) => {
  return (
    <svg
      aria-hidden="true"
      data-prefix="fas"
...
export const Link: React.FC<ISvgProps> = (props) => {
  return (
    <svg
      aria-hidden="true"
      data-prefix="fas"
...
export const Design: React.FC<ISvgProps> = (props) => {
  return (
    <svg
      aria-hidden="true"
      data-prefix="fas"
...
export const Develope: React.FC<ISvgProps> = (props) => {
  return (
    <svg
      aria-hidden="true"
      data-prefix="fas"
